...
function M.setup()
	...
	-- 设置自动命令
	require("lsp.opts").setup_autocmds()
...
function M._register_commands()
	...
	vim.api.nvim_create_user_command("LspFileSizeInfo", function()
		local status = manager.get_large_file_status()
...
-- 按功能域分组导出
M.diagnostics = {
	open_all = require("lsp.opts").open_all_diagnostics,
	open_buffer = require("lsp.opts").open_buffer_diagnostics,
	copy_error = require("lsp.opts").copy_error_message,
}
