...
return {
	...
	config = function()
		...
		sticks.setup({
			...
			active_modified_char = "󰩮󰩮", -- 活动修改缓冲区（未保存更改）的字符
			inactive_modified_char = "󰩮", -- 非活动修改缓冲区（未保存更改）的字符
			alternate_modified_char = "󰩮", -- 备用修改缓冲区（未保存更改）的字符
			...
			list = {
				...
				active_indicator = "󰳾 ", -- 列表模式下选中项的指示符（例如，用于箭头导航）
				keys = {
